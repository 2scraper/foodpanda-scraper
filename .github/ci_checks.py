...
# enforcement. Verified by running this check against
# fixtures_generated.json: 0 matches. Kept as a CONTEXT allowlist rather than
# by loosening the pattern — a bare 32-hex string anywhere else still fails,
# which is the point.
